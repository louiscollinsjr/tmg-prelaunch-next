...
<div className="container max-w-5xl p-[22px]">
  ...
  >
    ...
    />
      ...
      <h2 className="~text-5xl/7xl md:~text-6xl/9xl font-bold mb-6 text-black tracking-tight">
        Sign up today to get early access to <span className="text-burnt-orange">local jobs</span>
      </h2>

      <button
        onClick={() => setIsModalOpen(true)}
        className="bg-burnt-orange ~px-5/10 ~py-4/8 ~text-base/3xl md:~text-3xl/5xl font-medium text-white  rounded-full hover:bg-opacity-90 transition-all flex items-center gap-2 font-roboto"
      >
        Join waitlist
